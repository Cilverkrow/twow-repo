# SSC LLM Bridge — Phase 1A hardening revision
...
| Final dialogue | 240 Unicode code points, 2 contiguous terminator runs |
...
```powershell
& 'C:\TW\ComTW\runbooks\ssc-llm-bridge-phase1a-hardening-20260829-035317\run-tests.ps1'
```
...
```powershell
& 'C:\Users\djfav\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe' 'C:\TW\ComTW\runbooks\ssc-llm-bridge-phase1a-hardening-20260829-035317\src\cli.mjs' --validate-only
```
