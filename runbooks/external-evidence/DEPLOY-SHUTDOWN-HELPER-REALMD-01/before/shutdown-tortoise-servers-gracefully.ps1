...
function Invoke-InValidatedConsole {
    ...
    try {
        ...
        if (-not [string]::Equals($actualTitle, $ExpectedWindowTitle, [System.StringComparison]::Ordinal) -and -not [string]::Equals($actualTitle, ('Administrator:  ' + $ExpectedWindowTitle), [System.StringComparison]::Ordinal)) {
