...
bool PlayerbotAIConfig::Initialize()
{
    ...
    // Read once during PlayerbotAIConfig::Initialize.  Runtime configuration
    // reloads do not own or restart the child lifecycle.
    externalLLMBridgeEnabled = config.GetBoolDefault("AiPlayerbot.ExternalLLMBridge.Enabled", false);
    externalLLMBridgeNodeExecutable = config.GetStringDefault("AiPlayerbot.ExternalLLMBridge.NodeExecutable", "");
    externalLLMBridgePackageRoot = config.GetStringDefault("AiPlayerbot.ExternalLLMBridge.PackageRoot", "");
