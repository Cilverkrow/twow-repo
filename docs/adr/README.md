...
| [0005](ADR-0005-preserve-upstream-history-and-modularize-incrementally.md) | Preserve upstream history; modularize incrementally | Accepted | WS-10 / WS-40 |
...
| [0012](ADR-0012-external-llm-process-and-fail-closed-admission.md) | External LLM child process with fail-closed admission | Accepted, deployment pending | WS-10 |
| [0013](ADR-0013-llm-wire-package-and-lifecycle-contract.md) | Strict wire, package, and child-lifecycle contract | Accepted, deployment pending | WS-10 / WS-40 |
