...
Invoke-Clean $cmake @('-S',$source,'-B',$build,'-G','Visual Studio 17 2022','-A','x64','-DCMAKE_PREFIX_PATH=C:/TW/ComTW/vcpkg/installed/x64-windows',("-DROSTER_TEST_OPENSSL_LIBRARY="+$crypto))
